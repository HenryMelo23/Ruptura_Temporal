...
fonte_path = "Type Machine.ttf"  # Substitua pelo caminho correto
fonte = pygame.font.Font(fonte_path, 20)

# Mensagem a ser exibida
mensagem = "Assim que cheguei na masmorra, aquele cheiro horrível me atingiu como uma tempestade. Apareceu uma criatura grotesca, de pelo sujo e olhos injetados, que me lançou um grunhido misturado ao fedor. Tive que segurar a respiração enquanto desviava dos ataques. Cada movimento era uma batalha contra ele e contra o ar pesado ao meu redor."
...
segunda_mensagem = "Então finalmente, com o último golpe, o derrotei. O alívio de ter vencido aquela criatura era enorme, mas algo em mim continuava diferente... estranho."

# Renderizar o texto da segunda mensagem
segundo_texto = fonte.render(segunda_mensagem, True, (255, 255, 0))  # Verde: (0, 255, 0)
...
if segundo_texto.get_width() > largura_texto:
    ...
    for palavra_segundo_texto in palavras_segundo_texto[1:]:
        ...
        if fonte.render(teste_linha_segundo_texto, True, (255, 255, 0)).get_width() <= largura_texto:  # Verde: (0, 255, 0)
...
def renderizar_com_efeito_digitar_segundo_texto(segunda_texto_completo, fonte, largura_texto):
    ...
    for linha_idx, linha_segundo_texto in enumerate(linhas_segundo_texto):
        ...
        for char_idx, char_segundo_texto in enumerate(linha_segundo_texto):
            ...
            texto_renderizado_segundo_texto = fonte.render(texto_segundo_linha, True, (255, 255, 0))  # Verde: (0, 255, 0)
